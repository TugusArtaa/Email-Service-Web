...
function getEdit(id) {
    ...
    watch(fetchData.data, (newData) => {
        if (newData) {
            formRetry.id = id;
            formRetry.mail[0].to = newData.data.to;
            formRetry.mail[0].subject = newData.data.subject;
            formRetry.mail[0].content = newData.data.content;
            formRetry.mail[0].attachment[0] = newData.data.attachment[0];
            formRetry.mail[0].priority = newData.data.priority;
...
function handleRetry() {
    formRetry.post(`${baseUrl}/api/email-queue/retry`)
...
<template>
    <table class="w-full text-sm text-left text-gray-500 border dark:text-gray-400 rounded-2xl">
        ...
        <tbody>
            ...
            <tr v-if="(!props.logs.data || props.logs.data.length === 0) && !fetch">
                <td colspan="7" class="px-6 py-4 text-lg font-bold text-center">Tidak ada data yang ditemukan!</td>
            </tr>
            <tr v-for="(item, index) in logs.data" :key="item.id" v-if="!fetch"
                ...
                <td class="px-6 py-4">
                    <div :class="item.status == 'success' ? 'bg-green-200 text-green-900' : 'bg-red-200 text-red-900'"
                ...
                <td class="flex gap-1 px-6 py-4">
                    ...
                    <Tippy content="Delete Log">
                        <button type="button" @click="showDeleteModal = true; deleteOne = [item.id]"
    ...
    <!-- retry -->
    <div v-if="showEditModal" id="crud-modal" tabindex="-1" aria-hidden="true"
                ...
                <form class="p-4 md:p-5">
                    <div v-show="editFetch" class="grid grid-cols-2 gap-4 mb-4">
                        <div class="col-span-2">
                            ...
                            <input type="text" name="name" id="name" v-model="formRetry.mail[0].to"
                        ...
                        <div class="col-span-2">
                            ...
                            <input type="text" name="name" id="name" v-model="formRetry.mail[0].subject"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                placeholder="Type product name" required="">
                        </div>
                        <div class="col-span-2">
                            ...
                            <textarea id="description" rows="4" v-model="formRetry.mail[0].content"
                        ...
                        <div class="col-span-2">
                            ...
                            <input type="text" name="name" id="name" v-model="formRetry.mail[0].attachment[0]"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                placeholder="Type product name" required="">
                        </div>
                        <div class="col-span-2">
                            ...
                            <input type="text" name="name" id="name" v-model="formRetry.mail[0].priority[0]"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                placeholder="Type product name" required="">
                        </div>
                        <button @click="handleRetry" type="button" class="text-white w-fit bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-green-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Submit</button>
                    </div>
                    <div v-show="!editFetch" role="status" class="flex justify-center">
                        <svg aria-hidden="true"
                            class="inline w-8 h-8 text-gray-200 animate-spin dark:text-gray-600 fill-green-500"
                            viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                ...
                <form class="p-4 md:p-5">
                    <div v-show="detailFetch" class="grid grid-cols-2 gap-4 mb-4">
                        <div class="col-span-2">
                            ...
                            <input readonly disabled type="text" name="name" id="name" :value="logDetail.to"
                        ...
                        <div class="col-span-2">
                            ...
                            <input readonly disabled type="text" name="name" id="name" :value="logDetail.subject"
                                class="bg-gray-50 cursor-not-allowed border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                placeholder="Type product name" required="">
                        </div>
                        <div class="col-span-2">
                            <label for="description"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Content</label>
                            <textarea readonly disabled id="description" rows="4" :value="logDetail.content"
                        ...
                        <div class="col-span-2" v-for="(item, index) in logDetail.attachment">
                            <label for="name"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Attachment
                                {{+ + index }}</label>
                            <input readonly disabled type="text" name="name" id="name" :value="item"
                                class="bg-gray-50 cursor-not-allowed border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                placeholder="Type product name" required="">
                        </div>
                        <div class="col-span-2">
                            ...
                            <textarea readonly disabled id="description" rows="4" :value="logDetail.status"
                                class="block cursor-not-allowed p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                placeholder="Write product description here"></textarea>
                        </div>
                        <div class="col-span-2 mt-2">
                            <label for="description"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Error
                                Message</label>
                            <textarea readonly disabled id="description" rows="4" :value="logDetail.error_message"
                                class="block cursor-not-allowed p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                placeholder="Write product description here"></textarea>
                        </div>
                    </div>
        ...
        <div class="relative w-full max-w-md max-h-full p-4">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700" ref="deleteModal">
                ...
                <div class="p-4 text-center md:p-5">
                    ...
                    <button @click="deleteLog" data-modal-hide="popup-modal" type="button"
