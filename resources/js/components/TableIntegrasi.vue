...
const emit = defineEmits(['checkbox', 'delete']);
...
// console.log(props.logs.data.length)
</script>
                ...
                <form class="p-4 md:p-5">
                    <div v-show="detailFetch" class="grid grid-cols-2 gap-4 mb-4">
                        ...
                        <div class="col-span-2 mt-2">
                            <label for="description"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Error Message</label>
