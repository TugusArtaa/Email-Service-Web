...
function detailEmail(index) {
    email.value = emails.value.mail[index];
        ...
        <div
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div v-show="!formModal" class="grid grid-cols-3 p-4 gap-x-2 gap-y-4 md:p-5 max-h-[70vh] overflow-auto">
                    <!-- card -->
                    <div @click="formModal = true, detailEmail(index), index"
                        class="border py-1.5 px-2 rounded-md overflow-hidden" v-for="(item, index) in emails.mail">
                    ...
                    <div class="flex flex-col items-center justify-center text-green-700 border border-green-400 border-dashed cursor-pointer hover:text-green-500" @click="newEmail(), formModal = true">
                ...
                <!-- Modal body form -->
                <form v-show="formModal" class="grid grid-cols-3 p-4 md:p-5 gap-x-5 gap-y-4 max-h-[70vh] overflow-auto">
                    <div>
                        <label for="subject"
                    ...
                    <div>
                        ...
                        <input type="text" id="first_name" v-model="email.to"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                ...
                <div
                    ...
                    <!-- add new -->
                    <button data-modal-hide="extralarge-modal" type="button" v-if="formModal"
                    ...
                    <!-- edit changes -->
                    <button data-modal-hide="extralarge-modal" type="button" @click="saveEdit" v-if="formModal"
